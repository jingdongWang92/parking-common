...
public class HttpUtil {
     ...
     * @return 远程主机响应正文
     */
    public static String sendPostSSLJsonRequest(String reqURL, Map<String, String> params) {
        String sessionId = logStart("get", reqURL);
        logCenter("get", sessionId, null, params, null, null);
    ...
    private static void logCenter(String type, String sessionId, Map<String, String> headers,
        ...
        String objectJsonStr = object.toJSONString();
